...
Begin VB.Form frmMain 
   ...
   Begin VB.CheckBox chkIgnoreControlsPrefix 
      ...
      Left            =   210
      TabIndex        =   39
      ToolTipText     =   "התעלם מפונקציות שמתחילות במקדמים הבאים:"
      Top             =   7740
      Value           =   1  'Checked
      Width           =   2385
   End
   ...
   Begin VB.CheckBox chkIgnoreOnErr 
      ...
      Left            =   210
      TabIndex        =   34
      ToolTipText     =   "התעלם מפונקציות המכילות טיפול בשגיאות"
      Top             =   7440
      Value           =   1  'Checked
      Width           =   3765
   End
   ...
   Begin VB.CommandButton cmdTransfer 
      ...
      Left            =   9270
      TabIndex        =   28
      ToolTipText     =   "החלפת הקבצים המקוריים בקבצים המעובדים"
      Top             =   7650
      Width           =   1125
   End
   ...
   Begin VB.CheckBox chkApplyOnFunc 
      ...
      Left            =   2130
      TabIndex        =   11
      ToolTipText     =   "החל טיפול בשגיאות על פונקציות"
      Top             =   7110
      Value           =   1  'Checked
      Width           =   1815
   End
   Begin VB.CheckBox chkApplyOnProc 
      ...
      Left            =   210
      TabIndex        =   10
      ToolTipText     =   "החל טיפול בשגיאות על פרוצדורות"
      Top             =   7110
      Value           =   1  'Checked
      Width           =   1815
   End
